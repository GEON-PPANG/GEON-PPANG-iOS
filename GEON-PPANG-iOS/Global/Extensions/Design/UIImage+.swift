...
extension UIImage {
    ...
    static let sadEmoji = UIImage(named: "icon_sad")!.withRenderingMode(.alwaysOriginal)
    static let smileEmoji = UIImage(named: "icon_smile")!.withRenderingMode(.alwaysOriginal)
